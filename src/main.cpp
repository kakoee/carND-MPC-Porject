      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          Eigen::Map<Eigen::VectorXd> points_x_(&points_x[0], 6);
          Eigen::Map<Eigen::VectorXd> points_y_(&points_y[0], 6);

          auto coeffs = polyfit(points_x_, points_y_, 3);
          ...
          // SUBMITTING.
          this_thread::sleep_for(chrono::milliseconds(act_delay));
